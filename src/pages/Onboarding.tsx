        ...
        {LANGUAGES.map(l => (
          <button
            ...
            style={{
              padding: "13px 10px",
              borderRadius: 14,
              border: language === l.value ? "1.5px solid rgba(198,139,89,0.7)" : "1px solid rgba(255,255,255,.12)",
              background: language === l.value ? "rgba(198,139,89,0.15)" : "rgba(249,249,247,.04)",
              color: language === l.value ? "#E8C9A0" : "rgba(249,249,247,.6)",
              fontSize: 13,
          ...
          return (
            <button
              ...
              style={{
                padding: "9px 16px",
                borderRadius: 100,
                border: selected ? "1.5px solid rgba(198,139,89,0.7)" : "1px solid rgba(255,255,255,.12)",
                background: selected ? "rgba(198,139,89,0.15)" : "rgba(249,249,247,.04)",
                color: selected ? "#E8C9A0" : "rgba(249,249,247,.6)",
                fontSize: 13,
          ...
          {[0, 1, 2].map(i => (
            <div
              ...
              style={{
                ...
                height: 4,
                borderRadius: 100,
                background: i <= step ? "rgba(198,139,89,0.7)" : "rgba(255,255,255,.12)",
